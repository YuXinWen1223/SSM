...
/*        for (int i = 0; i <5 ; i++) {
     ...
     */
    @Test
    public void getSnameStudent() {
        SqlSession sqlSession = SqlSessionUtil.getSqlSession();
        StudentMapper mapper = sqlSession.getMapper(StudentMapper.class);
        System.out.println(mapper.getSnameStudent("余欣文"));
     ...
     */
    @Test
    public void getSnameStudentCount() {
        SqlSession sqlSession = SqlSessionUtil.getSqlSession();
        StudentMapper mapper = sqlSession.getMapper(StudentMapper.class);
        System.out.println(mapper.getSnameStudentCount("余欣文"));

    }

    @Test
    public void getgetSnameMap() {
        SqlSession sqlSession = SqlSessionUtil.getSqlSession();
        StudentMapper mapper = sqlSession.getMapper(StudentMapper.class);
        System.out.println(mapper.getgetSnameMap("余欣文"));

    }

    @Test
    public void getgetSnameMapList() {
        SqlSession sqlSession = SqlSessionUtil.getSqlSession();
        StudentMapper mapper = sqlSession.getMapper(StudentMapper.class);
        System.out.println(mapper.getgetSnameMapList());

    }

    @Test
    public void getLikeSnameStudent() {
        SqlSession sqlSession = SqlSessionUtil.getSqlSession();
        StudentMapper mapper = sqlSession.getMapper(StudentMapper.class);
        System.out.println(mapper.getLikeSnameStudent("余欣文"));
    ...
    public void tableName() {
        SqlSession sqlSession = SqlSessionUtil.getSqlSession();
        StudentMapper mapper = sqlSession.getMapper(StudentMapper.class);
        System.out.println(mapper.tableName("余欣文"));
